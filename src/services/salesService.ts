...
function toDbRecord(record: SalesRecord, uploadId?: string) {
  return {
    ...
    promo_value_1: record.promoValue1 ?? null,
    promo_value_2: record.promoValue2 ?? null,
    order_total_value: record.orderTotalValue ?? null,
    bonus_total_value: record.bonusTotalValue ?? null,
    client_total_sale: record.clientTotalSale ?? null,
    bonus_unique_number: record.bonusUniqueNumber ?? null,
    operation_description: record.operationDescription ?? null,
    considered_value: record.consideredValue ?? null,
    percent_sale_price_discount: record.percentSalePriceDiscount ?? null,
    percent_contract_discount: record.percentContractDiscount ?? null,
    percent_manual_bonus: record.percentManualBonus ?? null,
    total_percent_discounts: record.totalPercentDiscounts ?? null,
    percent_gross_to_pay: record.percentGrossToPay ?? null,
    percent_discount: record.percentDiscount ?? null,
    percent_final_commission: record.percentFinalCommission ?? null,
    representative_commission: record.representativeCommission ?? null,
    manager_commission: record.managerCommission ?? null,
    premium_paid_value: record.premiumPaidValue ?? null,
...
function fromDbRecord(row: any): SalesRecord {
  return {
    ...
    group: row.group,
    family: row.family,
    promoValue1: row.promo_value_1,
    promoValue2: row.promo_value_2,
    orderTotalValue: row.order_total_value,
    bonusTotalValue: row.bonus_total_value,
    clientTotalSale: row.client_total_sale,
    bonusUniqueNumber: row.bonus_unique_number,
    operationDescription: row.operation_description,
    consideredValue: row.considered_value,
    percentSalePriceDiscount: row.percent_sale_price_discount,
    percentContractDiscount: row.percent_contract_discount,
    percentManualBonus: row.percent_manual_bonus,
    totalPercentDiscounts: row.total_percent_discounts,
    percentGrossToPay: row.percent_gross_to_pay,
    percentDiscount: row.percent_discount,
    percentFinalCommission: row.percent_final_commission,
    representativeCommission: row.representative_commission,
    managerCommission: row.manager_commission,
    premiumPaidValue: row.premium_paid_value,
